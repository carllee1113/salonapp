...
// Explicit type for Chevron icon props used by DayPicker components
// Match DayPicker's expected props shape
...
function Calendar({
  ...
  const defaultComponents = {
    Chevron: (props: ChevronProps) => {
      const { orientation = "right", size = 16, className, disabled, ...rest } = props;
      if (orientation === "left") {
        return (
          <ChevronLeft
            size={size}
