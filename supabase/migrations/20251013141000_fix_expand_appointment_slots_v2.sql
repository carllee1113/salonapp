-- Migration: fix ambiguous column reference without renaming parameter
-- Description:
--  - Keeps the original function signature expand_appointment_slots(appointment_id uuid)
--  - Qualifies table column references to avoid ambiguity
...
begin
  ...
  -- IMPORTANT: qualify column reference to avoid parameter/column ambiguity
